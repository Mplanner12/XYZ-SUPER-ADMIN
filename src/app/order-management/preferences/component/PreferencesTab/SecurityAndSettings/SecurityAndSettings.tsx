...
const SecurityAndSettings = () => {
  ...
  return (
    <main>
      <h2 className="text-lg md:text-2xl font-semibold mb-6">Security Settings</h2>

      <div className="mb-6">
        <h2 className="text-base md:text-xl font-medium mb-4">Two-factor Authentication</h2>
      ...
      <h2 className="text-lg md:text-2xl font-semibold mb-2">Login Session Expiration</h2>
        <CustomInput
