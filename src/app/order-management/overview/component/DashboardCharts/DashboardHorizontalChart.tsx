...
const HorizontalChart = dynamic(() => import('@/components/Charts/HorizontalChart/HorizontalChart'), {
    loading: () => <p>Loading...</p>,
    ssr: false
  });

const DashboardHorizontalChart: React.FC = () => {
    const categories = [
        "Monday",
        "Tuesday",
        "Wednesday",
