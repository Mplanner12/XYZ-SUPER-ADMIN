...
interface ManageCustomerInvoiceTableProps<T> {
  initialData: T[];
...
const ManageCustomerInvoiceTable = <T,>({ initialData, columns, title, showAddMore = true, showExpand = true, ActionAddLocationClick }: ManageCustomerInvoiceTableProps<T>) => {
...
export default ManageCustomerInvoiceTable;
