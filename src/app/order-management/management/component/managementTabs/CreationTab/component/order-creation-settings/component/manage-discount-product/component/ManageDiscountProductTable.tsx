...
interface ManageDiscountProductTableProps<T> {
  initialData: T[];
...
const ManageDiscountProductTable = <T,>({ initialData, columns, title, showAddMore = true, showExpand = true, ActionAddLocationClick }: ManageDiscountProductTableProps<T>) => {
...
export default ManageDiscountProductTable;
