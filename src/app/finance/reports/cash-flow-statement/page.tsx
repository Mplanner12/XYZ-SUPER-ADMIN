      ...
      <div className='px-6 pt-6 mb-4'>
        <div className='bg-secondary rounded-[16px] py-6 px-4 mt-4'>
          ...
          <div className="flex justify-between my-3">
            <div className="mb-3">
              <p className="text-xl font-medium mb-3">Cash Flow Satement</p>
              ...
              <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                ...
                <tbody className="w-full bg-white">
                  ...
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
                    ...
                    <td className="py-6  text-left ">Net Cash from Operating Activities</td>
                  ...
                  <tr className=" border-[#eaecf0] hover:bg-[#F2F8FF] text-[14px] border-b text-[#545A5D]">
                    ...
                    <td className="py-6  text-left text-[#939292]">Purchase of Property, Plant, and Equipment</td>
                    <td className="py-6  text-left ">-100,000</td>
                  </tr>
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
                    <td className="py-6 pl-5 text-left "></td>
                    <td className="py-6  text-left ">Net Cash used in Investing Activities</td>
                    <td className="py-6 border-t border-[#434343] text-left ">
                      -100,000
                    </td>
                  </tr>
                  ...
                  <tr className=" border-[#eaecf0] bg-[#F0F0F0] curor-pointer text-[14px] border-b text-[#545A5D]">
                    <td className="py-6 pl-5 text-left ">
                      <div className="flex items-center gap-1">
                        Cash Flows from Financing Activities <ChevronDownIcon size="17px" />
                      </div>
                    </td>
                    <td className="py-6  text-left "></td>
                    <td className="py-6  text-left "></td>
                  ...
                  <tr className=" border-[#eaecf0] hover:bg-[#F2F8FF] text-[14px] border-b text-[#545A5D]">
                    <td className="py-6 pl-5 text-left ">30010</td>
                    <td className="py-6  text-left text-[#939292]">Issuance of Common Stock</td>
                    <td className="py-6  text-left ">100,000</td>
                  </tr>
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
                    <td className="py-6 pl-5 text-left "></td>
                    <td className="py-6  text-left ">Net Cash from Financing Activities</td>
                    <td className="py-6 border-t border-[#434343] text-left ">
                      100,000
                    </td>
                  </tr>
                  ...
                  <tr className=" border-[#eaecf0] bg-[#F0F0F0] curor-pointer text-[14px] border-b text-[#545A5D]">
                    <td className="py-6 pl-5 text-left ">
                      <div className="flex items-center gap-1">
                        Net Increase in Cash and Cash Equivalents <ChevronDownIcon size="17px" />
                      </div>
                    </td>
                    <td className="py-6  text-left "></td>
                    <td className="py-6  text-left "></td>
                  ...
                  <tr className=" border-[#eaecf0] hover:bg-[#F2F8FF] text-[14px] border-b text-[#545A5D]">
                    <td className="py-6 pl-5 text-left "></td>
                    <td className="py-6  text-left text-[#939292]">Cash and Cash Equivalents at Beginning of Period</td>
                    <td className="py-6  text-left ">14,500</td>
                  </tr>
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
                    <td className="py-6 pl-5 text-left "></td>
                    <td className="py-6  text-left ">Cash and Cash Equivalents at End of Period</td>
                    <td className="py-6 border-t border-[#434343] text-left ">
                      14,500
                    </td>
                  </tr>
