...
const EquityStatement: React.FC = () => {
      ...
      <div className='px-6 pt-6 mb-4'>
        <div className='bg-secondary rounded-[16px] py-6 px-4 mt-4'>
          ...
          <div className="flex justify-between my-3">
            <div className="mb-3">
              <p className="text-xl font-medium mb-3">Equity Statement</p>
              ...
              <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                <thead className="w-full">
                  <tr className="text-[#374B58] text-[12px] border-[#eaecf0]  border-b  font-[500] bg-[#F5F5F5]">
                    ...
                    <td className="py-5 gap-2 items-center">Common Stock (USD)</td>
                    <td className="py-5 gap-2 items-center">Reatined Earnings (USD)</td>
                    <td className="py-5 gap-2 items-center">Total Equity (USD)</td>
                  </tr>
                </thead>
                ...
                <tbody className="w-full bg-white">
                  ...
                  {equities?.map((equity, index)=>(
                    <tr key={index} className=" border-[#eaecf0] hover:bg-[#F2F8FF] text-[14px] text-[#939292] border-b">
                      <td className="py-6 pl-5 text-left ">{equity?.code}</td>
                      <td className="py-6  text-left ">{equity?.name}</td>
                      <td className="py-6  text-left ">{equity?.common}</td>
                      <td className="py-6  text-left ">{equity?.reatined}</td>
                      <td className="py-6  text-left ">{equity?.total}</td>
                    </tr>
                  ))}
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]">
                    ...
                    <td className="py-6 text-left">6,500</td>
                    <td className="py-6 text-left">6,500</td>
                  </tr>
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px] text-[#939292]">
                  ...
                  <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]">
                    <td className="py-6 pl-5 text-left "></td>
                    <td className="py-6  text-left ">Balance at End of Period</td>
                    <td className="py-6 border-t border-[#434343] text-left ">
                      100,000
                    </td>
                    <td className="py-6 border-t border-[#434343] text-left">-10,000</td>
                    <td className="py-6 border-t border-[#434343] text-left ">
                      90,000
                    </td>
                  </tr>
