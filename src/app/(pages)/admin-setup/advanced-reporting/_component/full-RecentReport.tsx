...
interface FullRecentReportProps {
...
const FullRecentReport: React.FC<FullRecentReportProps> = ({handleTabChange}) => {
  ...
  return (
    <div>
      <div className="flex gap-2 item-center align-middle cursor-pointer hover:text-foundation-purple-purple-400">
        ...
        <h2
          className="text-xl font-normal flex gap-1 items-center"
      ...
      <div className="flex md:w-[40%] w-full py-4">
...
export default FullRecentReport