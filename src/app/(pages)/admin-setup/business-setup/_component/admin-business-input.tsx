...
import { useCreateBusinessLocation, useCreateBusinessLocationItem, useCreateLocations } from '@/hooks/mutate';
...
const AdminBusinessInputLocation: React.FC<BusinessInputLocationProps> = ({onNext, onPrev}) => {const [businessId, setBusinessId] = useState<number | null>(null);
          ...
          <div className="mt-2 flex flex-col gap-y-4">
            ...
            <div className="flex md:flex-row flex-col w-full gap-10">
              <SelectElement
                ...
                options={
                  currencyResponse &&
                  currencyResponse.map((currency: { name: string }) => ({
                    value: currency.name,
                    label: currency.name,
                  }))
                }
...
export default AdminBusinessInputLocation;
