...
interface SetupOwnershipInformationProps {
  onNext: () => void;
  onPrev: () => void;
}

const SetupOwnershipInformation: React.FC<SetupOwnershipInformationProps> = ({
  onPrev, onNext
}) => {
...
export default SetupOwnershipInformation;
