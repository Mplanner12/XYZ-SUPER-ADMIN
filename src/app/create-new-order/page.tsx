"use client";
import CreateNewOrderUnauthorize from './UnauthorizeLayout'
...
import CreateOrderInfoTab from '../order-management/management/component/managementTabs/CreationTab/component/create-new-order/CreateOrderInfoTab/CreateOrderInfoTab';
import ImportOrderExelSheet from '../order-management/management/component/managementTabs/CreationTab/component/create-new-order/component/ImportOrderExelSheet/ImportOrderExelSheet';
import AddNewCustomerModal from '../order-management/management/component/managementTabs/CreationTab/component/create-new-order/modal/AddNewCustomerModal';
...
const page = () => {
  ...
  return (
    <CreateNewOrderUnauthorize>
      <section>
      <main className='bg-white p-20 mx-20 rounded-md'>
