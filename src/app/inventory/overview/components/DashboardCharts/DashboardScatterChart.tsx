...
const ScatterChart = dynamic(
	() => import('@/components/Charts/ScatterChart/ScatterChart'),
	{
		loading: () => <p>Loading...</p>,
		ssr: false,
	}
...
const InventoryScatterChart: React.FC = () => {
	const seriesData = [
		{
			name: 'Location 1',
			data: [
		...
		<div className="bg-white rounded-xl shadow-md py-6">
			<div className="flex justify-between gap-x-4 px-4 mb-4">
				<div className="text-base text-neutral-700">
					<p>Inventory Volume vs Product Sales</p>
				</div>
				<Image
					loading="lazy"
					src={download}
...
export default InventoryScatterChart;
