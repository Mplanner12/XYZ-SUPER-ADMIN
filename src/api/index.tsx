...
export const signUp = async (data: any) => {
  ...
  const res = await publicApi.post(`auth/direct/register`, data);
  return res.data;
};
...
export async function decodeToken(): Promise<DecodedTokenData | null> {
  try {
    ...
    const res = await publicApi.post<DecodedTokenResponse>(
    ...
    if (res.data && res.data.status === "success" && res.data.data) {
      ...
      await localStorage.setItem(
        "business_id",
        tokenData.business_id.toString()
      );
      return tokenData;
    } else {
...
export const addGeneralInformation = async (data: any): Promise<any | null> => {
  try {
    ...
    const res = await privateApi.post(
      `/account_setup/business/${user_id}/general-information`,
      data
    );
    return res.data;
  } catch (error) {
...
export const addLegalInformation = async (data: any): Promise<any | null> => {
  try {
    ...
    const res = await privateApi.post(
      `/account_setup/business/${business_id}/legal-information`,
      data
    );
    return res.data;
  } catch (error) {
...
export const addReportInformation = async (data: any): Promise<any | null> => {
  try {
    ...
    const res = await privateApi.post(
      `/account_setup/business/${business_id}/report-information`,
      data
    );
    return res.data;
  } catch (error) {
...
export const addOwnershipInformation = async (data: any) => {
  ...
  const res = await privateApi.post(
    `/account_setup/ownership-information?business_id=${businessId}`,
    data
  );
  return res.data;
};
...
export const updateOwnershipInformation = async ({
  ...
  const res = await privateApi.patch(
    `/account_setup/ownership-information/${ownership_id}`,
    data
  );
  return res.data;
};

export const deleteOwnershipInformation = async ({
  ownership_id,
  data,
}: {
  ownership_id: string;
...
export const addUpdateGeneralInformation = async (
  data: any
): Promise<any | null> => {
  try {
    const business_id = await localStorage.getItem("business_id");
...
export const updateModule = async ({
  ...
  const res = await privateApi.patch(
    `/account_setup/modules/${module_id}`,
    data
  );
  return res.data;
};
...
export const addSubmodules = async ({
  module_id,
  data,
}: {
  module_id: string;
  ...
  const res = await privateApi.post(
    `/account_setup/modules/${module_id}/submodules`,
    data
  );
  return res.data;
};
...
export const updateSubmodules = async ({
  ...
  const res = await privateApi.patch(
    `/account_setup/submodules/${submodule_id}`,
    data
  );
  return res.data;
};

export const deleteSubmodules = async ({
  submodule_id,
  data,
}: {
  submodule_id: string;
...
export const addLocation = async ({ data }: { data: any }) => {
  const businessId = await localStorage.getItem("business_id");
  const res = await privateApi.post(
    `/account_setup/locations?business_id=${businessId}`,
    data
  );
  return res.data;
};
...
export const deleteLocation = async ({
  ...
  const res = await privateApi.delete(
    `/account_setup/locations/${location_id}`,
    data
  );
  return res.data;
};
...
export const deleteDepartment = async ({
  ...
  const res = await privateApi.delete(
    `/account_setup/locations/${department_id}`,
    data
  );
  return res.data;
};
...
export const addCreateOtherPayment = async ({ data }: { data: any }) => {
  const res = await privateApi.post(`/account_setup/other_payment/`, data);
  return res.data;
};
...
export const addSubscription = async ({ data }: { data: any }) => {
  const businessId = await localStorage.getItem("business_id");
  const res = await privateApi.post(
    `/account_setup/subscriptions/?business_id=${businessId}`,
    data
  );
  return res.data;
};
...
export const updatePermissionsById = async ({
  data,
  permission_id,
}: {
  data: any;
  ...
  const res = await privateApi.patch(
    `/account_setup/edit-permission/${permission_id}`,
    data
  );
  return res.data;
};
...
export const addBusinessAccountRow = async ({ data }: { data: any }) => {
  const res = await privateApi.post(
    `/account_setup/business-account-row/`,
    data
  );
  return res.data;
};

export const updateBusinessAccountRowById = async ({
  row_id,
  data,
}: {
  row_id: any;
  ...
  const res = await privateApi.patch(
    `/account_setup/business-account-row/${row_id}
`,
    data
  );
  return res.data;
...
export const deleteBusinessAccountRowById = async ({
  row_id,
}: {
  row_id: any;
}) => {
  const res =
    await privateApi.delete(`/account_setup/business-account-row/${row_id}
`);
  return res.data;
};
...
export const updateInternalAdminById = async ({ data }: { data: any }) => {
  const res = await privateApi.patch(
    `/account_setup/internal_admin/{admin_id}
`,
    data
  );
  return res.data;
...
// ownership information
export const getOwnershipInformation = async ({
  business_id,
}: {
  business_id: string;
}) => {
  const res = await privateApi.get(
    `account_setup/ownership-information/${business_id}`
  );
  return res.data;
};
...
export const getAllBusinessUser = async ({ data }: { data: any }) => {
  const res = await privateApi.get(
    `account_setup/list-all-user-business`,
    data
  );
  return res.data;
};
...
// get all submodules
export const getListSubModules = async ({
  module_id,
}: {
  module_id: number;
}) => {
...
export const getModulesWithSubmodules = async ({ data }: { data: any }) => {
  const res = await privateApi.get(
    `account_setup/modules_with_submodules`,
    data
  );
  return res.data;
};
...
export const getBusinessLocations = async ({
  ...
  const res = await privateApi.get(
    `account_setup/business/${business_id}/locations`
  );
  return res.data;
};
...
export const getBusinessAccountRows = async ({
  business_id,
}: {
  business_id: any;
}) => {
  const res = await privateApi.get(
    `/account_setup/business-account-rows/${business_id}`
  );
  return res.data;
};
...
export const getAllAdminDetails = async ({ data }: { data: any }) => {
  const res = await privateApi.get(
    `/account_setup/internal_admin/details`,
    data
  );
  return res.data;
};
...
export const deleteSetupBusinesslocation = async ({
  id,
  data,
}: {
  id: any;
...
export const updateSetupBusinessLocation = async ({
  id,
  data,
}: {
  id: any;
