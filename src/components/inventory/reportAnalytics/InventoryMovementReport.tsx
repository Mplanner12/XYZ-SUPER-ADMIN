...
const columnHelper = createColumnHelper<InventoryMovementReportData>();
...
const InventoryMovementReport = () => {
	...
	// table data
	const [data, setData] = useState<InventoryMovementReportData[]>([
		{
			id: 1,
			transactionId: '39297',
				...
				<main>
					...
					<div className="flex justify-between">
						...
						<div className="flex justify-between text-sm text-foundation-purple-purple-400">
							<div className="flex gap-4">
								<p className="flex align-middle gap-2">
									Showing all Columns <ChevronDown color="#8133F1" size={24} />
								</p>
