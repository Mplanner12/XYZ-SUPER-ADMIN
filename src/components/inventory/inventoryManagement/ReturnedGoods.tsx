...
import { IoFilterSharp, IoReturnDownBackSharp } from 'react-icons/io5';
...
const columnHelper = createColumnHelper<ReturnedGoodsData>();
...
const ReturnedGoods: React.FC = () => {
	...
	const [data, setData] = useState<ReturnedGoodsData[]>([
		{
			id: 1,
	...
	return (
		<>
			<div className=" w-full mt-5 flex flex-col gap-4">
					...
					<main>
						<div className="flex justify-between items-center sm:pb-6 pb-4">
							...
							<p
								...
								onClick={() => handleTabChange('return-goods')}
							>
								<IoMdReturnLeft />
								Return Goods
							</p>
				...
				<div>
					{selectedTab === 'return-goods' && (
						<ReturnGoods handleTabChange={handleTabChange} />
					)}
				</div>
			</div>
		</>
