...
interface TransactionManagementdata {
	id: number;
...
const columnHelper = createColumnHelper<TransactionManagementdata>();
...
const TransactionManagement = () => {
	...
	// table data
	const [data, setData] = useState<TransactionManagementdata[]>([
		{
			id: 1,
			transactionId: '39297',
