...
interface SalesFulfillmentData {
	id: number;
	orderId: string;
	customerName: string;
	location: string;
...
const columnHelper = createColumnHelper<SalesFulfillmentData>();

const SalesFulfillment = () => {
	...
	// table data
	const [data, setData] = useState<SalesFulfillmentData[]>([
		{
			id: 1,
			orderId: '39297',
	...
	const columns = [
		...
		columnHelper.accessor('supplyDate', {
			header: 'Supply Date',
			cell: (info) => info.getValue(),
		}),
	];
	...
	return (
		<>
			<section className="pb-4 pt-6">
				<div className="text-foundation-black-black-400 text-xl py-2">
					<OverViewFilter
						label="Filter By Store"
						options={['Mushin Warehouse', 'Lekki Warehouse', 'Ojata Warehouse']}
...
export default SalesFulfillment;
