...
const locations = [
	...
	{ value: 'Mushin Warehouse', label: 'Mushin Warehouse' },
	{ value: 'Ajao', label: 'Ajao' },
];
...
const columnHelper = createColumnHelper<PurchaseOrderdata>();
	...
	return (
		<>
			<section className="pb-4 pt-6">
				<div className="text-foundation-black-black-400 text-xl flex justify-between py-2">
					<OverViewFilter
					...
					/>
					<p className="flex align-middle gap-2 text-sm text-foundation-purple-purple-400">
						<FaExternalLinkAlt color="#8133F1" size={18} /> Create a Purchase
						Order
					</p>
				</div>
