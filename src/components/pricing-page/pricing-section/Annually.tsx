...
interface AnnuallyPricingProps {
  id: number;
  name: string;
  nameSubsection: {
    field1?: string;
...
const moduleLists: AnnuallyPricingProps[] = [
  {
    id: 1,
...
const AnnuallyPricing: React.FC = () => {
  ...
  return (
    <>
      <div className="container pb-2 text-[14px] font-normal font-inter bg-white rounded-2xl whitespace-nowrap overflow-x-auto no-scroll overflow-scroll">
...
export default AnnuallyPricing;
