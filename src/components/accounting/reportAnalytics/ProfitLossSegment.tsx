import { ArrowUpNarrowWideIcon, ListFilterIcon, ChevronDownIcon } from 'lucide-react';
...
import { dateDropDownOption } from '@/data/dropDownOption';
import CustomSelect from '@/components/reusable/CustomSelect';


const ProfitLossSegment: React.FC = () => {
        ...
        <>
            <main>
                <div className='flex justify-between my-3'>
                    <div className='mb-3'>
                        <p className='text-xl font-medium mb-3'>Profit & Loss by Segment</p>
                ...
                <div className="flex mb-5 gap-4">
                    ...
                    <SelectDropDown
                        ...
                        options={["Standard", "YTD", "Comparison",]}
                ...
                <div className='text-[#8133F1] mb-2 text-[16px] flex gap-3'>
                    ...
                    <div className='overflow-x-auto scrollbar-hide'>
                        <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                            <thead className="w-full">
                                <tr className="text-[#374B58] text-[12px] border-[#eaecf0]  border-b  font-[500] ">
                            ...
                            <tbody className="w-full bg-white">
                                <tr className=" border-[#eaecf0] bg-[#F0F0F0] text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        <div className="flex items-center gap-1">
                                            Ordinary Income/Expenses  <ChevronDownIcon size="17px" color='#8133F1' />
                                        </div>
                                    </td>
                                ...
                                <tr className=" border-[#eaecf0] bg-[#F0F0F0] text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        <div className="flex items-center gap-1">
                                            Cost of Goods Sold  <ChevronDownIcon size="17px" color='#8133F1' />
                                        </div>
                                    </td>
                                    <td className="py-6  text-left ">
...
export default ProfitLossSegment;
