                    ...
                    <div className='overflow-x-auto scrollbar-hide'>
                        <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                            ...
                            <tbody className="w-full bg-white">
                                <tr className=" border-[#eaecf0] bg-[#F0F0F0] cursor-pointer text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        <div className="flex items-center gap-1">
                                            Cashflows from Operating Activities  <ChevronDownIcon size="17px" />
                                        </div>
                                    </td>
                                ...
                                <tr className=" border-[#eaecf0] bg-[#F0F0F0] cursor-pointer text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        <div className="flex items-center gap-1">
                                            Cashflows from investing Activities  <ChevronDownIcon size="17px" />
                                        </div>
                                    </td>
                                    <td className="py-6  text-left ">
                                ...
                                <tr className=" border-[#eaecf0] hover:bg-[#21262c] text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        400101
                                    </td>
                                    <td className="py-6  text-left ">
