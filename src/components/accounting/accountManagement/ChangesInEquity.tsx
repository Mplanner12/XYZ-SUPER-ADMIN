...
const ChangesInEquityTab: React.FC = () => {
        ...
        <>
            <main>
                <div className='flex justify-between my-3'>
                    <div className='mb-3'>
                        <p className='text-xl font-medium mb-3'>Changes In Equity</p>
                        ...
                        <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                            ...
                            <tbody className="w-full bg-white">
                                ...
                                <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
                                    ...
                                    <td className="py-6 border-[#8A8A8A] text-left ">
                                        500
                                    </td>
                                    <td className="py-6 border-[#8A8A8A] pr-5">
                                        1000
                                    </td>
                                    <td className=" py-6 pr-5 border-[#8A8A8A]">
                                        2000
                                    </td>
                                </tr>
                                <tr className=" border-[#eaecf0] border-b hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
...
export default ChangesInEquityTab;
