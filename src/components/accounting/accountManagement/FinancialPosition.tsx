...
import { ArrowUpNarrowWideIcon, ChevronDownIcon, ChevronUpIcon, ListFilterIcon, MessageSquareIcon, RotateCwIcon } from 'lucide-react';
...
const FinancialPositionTab: React.FC = () => {
        ...
        <>
            <main>
                <div className='flex justify-between my-3'>
                    <div>
                        <p className='text-xl font-medium mb-3'>Financial Position</p>
                    ...
                    <div className='overflow-x-auto scrollbar-hide'>
                        <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                            ...
                            <tbody className="w-full bg-white">
                                <tr onClick={() => toggleSection('revenue')} className=" border-[#eaecf0] bg-[#F0F0F0] table-row-hover text-[14px] border-b text-[#545A5D]">
                                ...
                                {expandedSections.includes('revenue') && (
                                    <>
                                        ...
                                        <tr className="border-[#eaecf0] border-b hover:bg-[#F7f7f7] text-[14px] text-[#545A5D]">
                                            ...
                                            <td className="py-6 border-[#8A8A8A] border-t-2 text-left">500</td>
                                        </tr>
                                    </>
                                )}
                                <tr onClick={() => toggleSection('costOfGoods')} className=" border-[#eaecf0] bg-[#F0F0F0] table-row-hover text-[14px] border-b text-[#545A5D]">
                                    <td className="py-6 pl-5 text-left ">
                                        <div className="flex items-center gap-1">
                                            Cost of Goods Sold
